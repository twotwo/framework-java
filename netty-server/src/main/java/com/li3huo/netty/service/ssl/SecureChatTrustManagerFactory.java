 ...
 * under the License.
 */
package com.li3huo.netty.service.ssl;
...
import com.li3huo.netty.service.proxy.HttpOutboundClientHandler;
...
public class SecureChatTrustManagerFactory extends TrustManagerFactorySpi {
	...
	private static final TrustManager DUMMY_TRUST_MANAGER = new X509TrustManager() {
		...
		public void checkClientTrusted(X509Certificate[] chain, String authType) {
			...
			logger.warn("UNKNOWN CLIENT CERTIFICATE: "
		...
		public void checkServerTrusted(X509Certificate[] chain, String authType) {
			// Always trust - it is an example.
			// You should do something in the real world.
			logger.warn("UNKNOWN SERVER CERTIFICATE: "
					+ chain[0].getSubjectDN());
		}
	};
